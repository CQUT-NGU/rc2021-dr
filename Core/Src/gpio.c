...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOI, RELAY_Pin|NIP_DIR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, PICK_L_DIR_Pin|PICK_R_DIR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = NIP_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(NIP_DIR_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = PICK_L_DIR_Pin|PICK_R_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
